<!--
  ELMASUNDER // README.md
  neo underground builder
-->
...
```
╔══════════════════════════════════════════════════════╗
║  E L M A S U N D E R . E X E                         ║
║  independent builder — interfaces / audio / systems  ║
╚══════════════════════════════════════════════════════╝
```
...
> status       : lost in liminalspaces
> sector       : immersive UI / narrative tech / system tooling
> mindset      : open source · copyleft · free palestine ◼
```
...
```
vue3 · nuxt3 · tailwind4 · typescript · powershell
narrative interfaces · system tooling · modular architecture
```
...
```
github      → github.com/Elmasunder
bnvanguard  → github.com/Elmasunder/BNVANGUARD
```
